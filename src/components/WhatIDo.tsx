        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Developing software and responsive web applications with strong foundations in object-oriented programming, data structures, and clean modular code.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Solved 200+ programming problems on online coding platforms, with expertise in version control, database querying, and collaborative development.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
